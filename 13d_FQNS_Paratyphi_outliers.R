...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
#read in data
mydata <- fread('Z:/AMR/Pathogens/typhi_paratyphi/model_prep/clean_data/FQNS_paratyphi_clean.csv')
...
pdf(paste0('Z:/AMR/Pathogens/typhi_paratyphi/model_prep/outliering/FQNS_paratyphi/MAD2.pdf'),
    height = 17,
    width = 12) 
...
pdf('Z:/AMR/Pathogens/typhi_paratyphi/model_prep/outliering/FQNS_paratyphi/DD_over2.pdf',
...
write.csv(mydata , "Z:/AMR/Pathogens/typhi_paratyphi/model_prep/outliering/FQNS_paratyphi/inspect_outliers.csv", row.names = F)
