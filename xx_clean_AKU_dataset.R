...
mydata_2007 <- mydata_2007[,.(CITY, ORG, year = 2007, AMP, C, SXT, NAL = V39, CIP)]
mydata_2008 <- fread("AGU_2008.csv")
mydata_2008 <- mydata_2008[,.(CITY, ORG, year = 2008, AMP, C, SXT, NAL = V42, CIP)]
mydata_2009 <- fread("AGU_2009.csv")
mydata_2009 <- mydata_2009[,.(CITY, ORG, year = 2009, AMP, C, SXT, NAL = V38, CIP)]
mydata_2010 <- fread("AGU_2010.csv")
mydata_2010 <- mydata_2010[,.(CITY, ORG, year = 2010, AMP, C, SXT, NAL = V39, CIP)]
mydata_2011 <- fread("AGU_2011.csv")
mydata_2011 <- mydata_2011[,.(CITY, ORG, year = 2011, AMP, C, SXT, NAL = V51, CIP)]
mydata_2012 <- fread("AGU_2012.csv")
mydata_2012 <- mydata_2012[,.(CITY, ORG, year = 2012, AMP, C, SXT, NAL = V50, CIP)]
mydata_2013 <- fread("AGU_2013.csv")
mydata_2013 <- mydata_2013[,.(CITY, ORG, year = 2013, AMP, C, SXT, NAL = V51, CIP)]
mydata_2014 <- fread("AGU_2014.csv")
mydata_2014 <- mydata_2014[,.(CITY, ORG, year = 2014, AMP, C, SXT, NAL = V57, CIP)]
mydata_2015 <- fread("AGU_2015.csv")
mydata_2015 <- mydata_2015[,.(CITY = City, ORG, year = 2015, AMP, C, SXT, NAL = V51, CIP)]
mydata_2019 <- fread("AGU_2019.csv")
mydata_2019 <- mydata_2019[,.(CITY, ORG, year = 2019, AMP=AMPA, C = CA, SXT = SXTA, NAL = NAU, CIP=CIPA)]
