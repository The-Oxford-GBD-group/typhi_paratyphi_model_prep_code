...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
#read in data
mydata <- fread('Z:/AMR/Pathogens/typhi_paratyphi/model_prep/clean_data/MDR_typhi_clean.csv')
...
pdf(paste0('Z:/AMR/Pathogens/typhi_paratyphi/model_prep/outliering/MDR_typhi/MAD2_5.pdf'),
    height = 17,
    width = 12) 
...
pdf('Z:/AMR/Pathogens/typhi_paratyphi/model_prep/outliering/MDR_Typhi/DD_over2.pdf',
...
write.csv(mydata , "Z:/AMR/Pathogens/typhi_paratyphi/model_prep/outliering/MDR_Typhi/inspect_outliers.csv", row.names = F)
